...
tests =
    testGroup
        ...
        , testGroup
            ...
            , testCase "JSON & CBOR for proof of kumquat" $ do
                let mpf :: MerklePatriciaForestry = fromList fruitsList
                ...
                BS16.encode (CBOR.toStrictByteString (proofToTermEncoding proof)) @?= ""
            ]
        ]
